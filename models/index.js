...
const MonthlyContribution = require('./MonthlyContribution')(sequelize, DataTypes);
...
const TotalTransferInsVdrs = require('./TotalTransferInsVdrs')(sequelize, DataTypes);
const EPFWithdrawal = require('./EPFWithdrawal')(sequelize, DataTypes);
const TaxableOpeningBalance = require('./TaxableOpeningBalance')(sequelize, DataTypes);
const TaxableMonthlyEntry = require('./TaxableMonthlyEntry')(sequelize, DataTypes);
const TaxableInterestUpdate = require('./TaxableInterestUpdate')(sequelize, DataTypes);
const TaxableClosingBalance = require('./TaxableClosingBalance')(sequelize, DataTypes);
